...
function Desk() {
  ...
  return (
    <main className="min-h-dvh bg-bg px-4 py-4 text-fg">
      ...
      <p className="mt-3 rounded-lg border border-danger/40 bg-surface px-3 py-2 text-sm text-danger">
        If you installed the old Pack Watch add-on, remove it in chrome://extensions or DDL login can stay broken.
      </p>
      <div className="mt-4">
        <ScreenWatch compact />
      </div>
