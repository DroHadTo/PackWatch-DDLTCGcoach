        ...
        {b.tab === "home" && (
          <section className="mx-auto max-w-xl py-8">
            ...
            <p className="mt-3 text-base leading-relaxed text-muted">
              Remove any old Pack Watch Chrome add-on — it blocked DDL login. This app never sits inside the
              game. Practice here, or call the live board by typing what you see.
            </p>
