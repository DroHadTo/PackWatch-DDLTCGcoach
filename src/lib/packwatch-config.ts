...
export const KICK_CHANNELS = ["guytypeaura", "akmetax"] as const;
export const KICK_TITLE_TERMS = ["ddltcg", "doginal dogs legends", "doginal dogs tcg"] as const;
...
export const NAV_ITEMS = [
  ...
  { id: "streamer" as const, label: "Streamer", short: "Kick watch" },
  { id: "commentator" as const, label: "Commentator", short: "Live call" },
];
