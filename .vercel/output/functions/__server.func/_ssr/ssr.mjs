...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bfz-Lu6k.mjs");
...
var manifest = { "8e7f377214126115aabbae8713dff47c84e3b65a99bf079f38b786392b3f9007": {
	functionName: "learnFrame_createServerFn_handler",
	importer: () => import("./learn-frame-SLAx4j-g.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Dcu3bABv.mjs").then((n) => n.t),
