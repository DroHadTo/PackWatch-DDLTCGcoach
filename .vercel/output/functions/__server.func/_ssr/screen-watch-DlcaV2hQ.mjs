...
//#region node_modules/.nitro/vite/services/ssr/assets/screen-watch-DlcaV2hQ.js
	...
	async function sample(deep) {
		...
		try {
			...
			if (TD) {
				...
				text = (await new TD().detect(bmp)).map((h) => h.rawValue).join(" ");
				bmp.close();
			}
		} catch {}
		if (text) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			!compact && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Safety: Pack Watch never injects into DDL, never clicks, never reads cookies, never sees a window you did not share. Remove any old Chrome add-on named Pack Watch — that one sat on the login page."
			})
		]
	});
}
