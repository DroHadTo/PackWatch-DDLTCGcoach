...
import { i as ScreenWatch, m as useBrain, o as answerWatch } from "./screen-watch-mY4oK6s5.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/desk-p-o8LBUp.js
...
function Desk() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-3 rounded-lg border border-border bg-surface px-3 py-2 text-sm text-muted",
				children: "Advice-only: this companion never injects into DDL, clicks, types, reads cookies, or stores credentials."
			}),
